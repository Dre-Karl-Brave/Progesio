  ...
  features: [
    {
      ...
      bullets: [
        'AI ranks tasks by urgency and effort level',
        'Due date tracking with smart reminders',
        'Priority badges keep your focus sharp'
      ]
    },
    {
      title: 'AI-Powered Insights',
      description: 'Get intelligent summaries and trend analysis generated by AI directly from your productivity data.',
      skeleton: 'SkeletonTwo',
      bullets: [
        'Weekly summaries generated automatically',
        'Detects patterns in your work habits',
        'Trend analysis to keep you ahead of deadlines'
      ]
    },
    {
      title: 'Workload Balance',
      description: 'Visualize your weekly load and get warned before burnout hits — so you always stay in control.',
      skeleton: 'SkeletonThree',
      bullets: [
        'Color-coded daily intensity meter',
        'Burnout alerts before they happen',
        'Suggests redistributing tasks automatically'
      ]
    },
    {
      ...
      bullets: [
        'Natural language task creation and breakdown',
        'Breaks projects into step-by-step action items',
        'Adjusts priorities based on your current workload'
      ]
    }
  ]
}
