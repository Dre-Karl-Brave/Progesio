...
export default function DeleteBoardDialog({ boardName, onClose, onConfirm }) {
      ...
      <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm'>
        ...
        >
          <div className='relative border-b border-[#E5E7EB] p-6 pb-4'>
            ...
            <h2 className='text-xl font-bold text-[#0F172A]'>Delete Board?</h2>
          </div>
          ...
          <div className='p-6'>
            <div className='mb-6 space-y-3'>
              ...
              <p className='text-sm leading-relaxed text-[#475569]'>
                All columns, tasks, and data will be lost forever. This action cannot be undone.
              </p>
            </div>
