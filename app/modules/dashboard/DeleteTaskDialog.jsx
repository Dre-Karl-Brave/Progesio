...
export default function DeleteTaskDialog({ taskTitle, onClose, onConfirm }) {
      ...
      <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm'>
        ...
        >
          <div className='relative border-b border-[#E5E7EB] p-6 pb-4'>
            ...
            <h2 className='text-xl font-bold text-[#0F172A]'>Delete Task?</h2>
          </div>
          ...
          <div className='p-6'>
            <div className='mb-6 space-y-3'>
              ...
              <div className='rounded-lg bg-[#F8FAFC] px-3 py-2 border border-[#E5E7EB]'>
                <p className='text-sm font-semibold text-[#0F172A]'>{taskTitle}</p>
              </div>
              <p className='text-sm leading-relaxed text-[#475569]'>
