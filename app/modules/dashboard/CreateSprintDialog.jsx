...
export default function CreateSprintDialog({ boardId, onClose, onCreated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`/api/boards/${boardId}/sprints`, {
        name,
        goal,
        ...
        <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm'>
          ...
          >
            <div className='relative border-b border-[#E5E7EB] p-6 pb-4'>
              ...
              <h2 className='text-xl font-bold text-[#0F172A]'>Create Sprint</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className='p-6'>
              <div className='mb-6 space-y-4'>
                ...
                {/* Sprint Goal */}
                <div>
                  <label className='mb-2 block text-sm font-medium text-[#0F172A]'>Sprint Goal</label>
                  <textarea
                    value={goal}
                ...
                {/* Status */}
                <div>
                  <label className='mb-2 block text-sm font-medium text-[#0F172A]'>Status</label>
